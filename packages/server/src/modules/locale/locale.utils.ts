...
export const transformListToMap = (list: any[], localeDict: string[]) => {
...
export const getCompareLocaleStat = (oldList, newList, localeDict) => {
  ...
  localeDict.forEach((locale) => {
    stat[locale] = compareLocaleData(oldMap[locale] ?? {}, newMap[locale] ?? {})
  })
...
export const transformListToObj = (list: any[], localeDict) => {
  const map: Record<string, any> = {}
...
export const completeLocaleList = (list: any[], localeDict: string[]) => {
...
export const findStubInLocaleList = (list: any[], localeDict: string[]) => {
  const result: any[] = []
